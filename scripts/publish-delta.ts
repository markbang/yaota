...
const [baseId, targetId] = process.argv.slice(2);
if (!baseId || !targetId || !process.env.OTA_SERVER || !process.env.OTA_API_KEY) throw new Error("Usage: OTA_SERVER=https://host OTA_API_KEY=... node scripts/publish-delta.ts BASE_ID TARGET_ID");
